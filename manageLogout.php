...
<div class="container-fluid mar-top" > 
     ...
     <div class="card-body col-mg-12" style="background-color:#000; color:#fff; padding:20px">  <h4>Logout</h4></div>
  ...
  <div class="card-body">
                      ...
                      <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8" style="float:left">
                          ...
                          <div class="col-sm-5 col-xs-6 tital " style="font-size:20px">Time:<br />5:00pm</div>
