		   			...
		   			<div class="col-md-12 col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="page-heading"> <h6>Manage Products</h6></div>
								<?php if( ($_SESSION['type']['user_role'] == 'Admin')) { ?><button class="btn btn-info  m-1" id="add_product"><i class="fa fa-plus-square"></i> Add </button><?php } ?>
							</div> <!-- /panel-heading -->
    				...
    				<div class="modal-body">
						...
						<div class="row">
							...
							<input type="text" name="product_sp" id="product_sp" class="form-control" required />
								...
								<div class="form-group">
									<label>Markup %*</label>
									<select name="markup_rate" id="markup_rate" class="form-control" required>
